  ...
  return (
    <div className={styles.pageHeader}>
      <div
        ...
        style={{
          background: `url(${im}) -254px -67px no-repeat, url(${im}) 100% 100% no-repeat, linear-gradient(90deg,rgb(255, 255, 255) 100%,rgb(255, 255, 255) 72%,rgba(242,242,242,1) 74%, rgba(217,235,232,1) 77%,rgba(246,255,254,1) 100%)`,
        }}
      >
